...
@Composable
fun SelecionadosHeader(telaInicialViewModel: TelaInicialViewModel) {
    MediumTopAppBar(
        ...
        title = {
            TextButton(onClick = { /*TODO*/ }) {
                ...
                Text(text = "Seleciona Todos")
            }

        },
        navigationIcon = {
            Row(verticalAlignment = Alignment.CenterVertically) {
                IconButton(onClick = { telaInicialViewModel.onSelectedChange(false) }) {
                    Icon(
